<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($_FILES['file']['name'] !=''){
            ...
            if($filesize < 800000){
                if(in_array($fileActualext, $allow)){
                    ...
                    if(move_uploaded_file($fileTmp, $location)){
                       ...
                       $sql = "UPDATE `admin` SET `name` = '$name', `phone` = '$phone', `face` = '$fac', `twit` = '$twi', `insta` = '$inst', `description` = '$desc', `img` = '$pic' WHERE `id` = '$adminid'";
            ...
            $sql = "UPDATE `admin` SET `name` = '$name', `phone` = '$phone', `face` = '$fac', `twit` = '$twi', `insta` = '$inst', `description` = '$desc'  WHERE `id` = '$adminid'";
